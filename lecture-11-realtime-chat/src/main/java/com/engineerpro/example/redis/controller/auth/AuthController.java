...
import com.engineerpro.example.redis.dto.GetUsernameResponse;
...
public class AuthController {
  ...
  @GetMapping("/inspect/username")
  public ResponseEntity<GetUsernameResponse> getUsername(Authentication authentication) {
    return ResponseEntity.ok().body(GetUsernameResponse.builder().username(authentication.getName()).build());
  }
