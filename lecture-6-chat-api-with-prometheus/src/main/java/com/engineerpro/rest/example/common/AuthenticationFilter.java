...
public class AuthenticationFilter implements Filter {
  ...
  private final ForbiddenMetrics forbiddenMetrics;

  public AuthenticationFilter(AppService appService, ForbiddenMetrics forbiddenMetrics) {
    this.appService = appService;
    this.forbiddenMetrics = forbiddenMetrics;
  }
  ...
  public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
    ...
    if (apiClientKey == null) {
      forbiddenMetrics.incrementCounter();
